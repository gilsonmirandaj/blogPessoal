package blog.src.main.java.PersonalBlog.configuration;
...
public class SwaggerConfig {
        ...
        public Docket api() {
            return new Docket(DocumentationType.SWAGGER_2)
                    ...
                    .apis(RequestHandlerSelectors
                            .basePackage("blog.src.main.java.PersonalBlog.controller"))
        ...
        private static Contact contact() {
            return new Contact("Gilson Miranda Junior",
                    "https://github.com/gilsonmirandaj",
                    "gilsonmirandajunior2@gmail.com");
        }
